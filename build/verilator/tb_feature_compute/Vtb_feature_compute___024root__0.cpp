...
VlCoroutine Vtb_feature_compute___024root___eval_initial__TOP__Vtiming__0(Vtb_feature_compute___024root* vlSelf) {
    ...
    co_await vlSelfRef.__VdlySched.delay(0x00000000000186a0ULL, 
                                         nullptr, "/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 
                                         37);
    co_return;
}
...
VlCoroutine Vtb_feature_compute___024root___eval_initial__TOP__Vtiming__1(Vtb_feature_compute___024root* vlSelf) {
    ...
    while (VL_LIKELY(!vlSymsp->_vm_contextp__->gotFinish())) {
        co_await vlSelfRef.__VdlySched.delay(0x0000000000001388ULL, 
                                             nullptr, 
                                             "/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 
                                             32);
...
bool Vtb_feature_compute___024root___eval_phase__inact(Vtb_feature_compute___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT("/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 11, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
...
#endif
            VL_FATAL_MT("/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 11, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 100 tries");
        }
        __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
        vlSelfRef.__VinactIterCount = 0U;
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VinactIterCount)))) {
                VL_FATAL_MT("/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 11, "", "DIDNOTCONVERGE: Inactive region did not converge after '--converge-limit' of 100 tries");
            }
            ...
            do {
                if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                    ...
                    Vtb_feature_compute___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                    VL_FATAL_MT("/Users/eeshanahari/Dual-FPGA-Trading-Engine/tb/board_b/tb_feature_compute.sv", 11, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 100 tries");
                }
