...
module tb_msg_demux;
    ...
    initial begin
        ...
        // Exact 128-bit frames generated by running golden model
        // (board_a.py with seed=0xDEADBEEF, 4 symbols, CALM regime).
        // See golden_model/vectors/demux_vectors.json for full set.
        // ────────────────────────────────────────────────────────────────
        $display("\n=== TEST 9: Golden model reference frames ===");
        begin
            logic [FRAME_W-1:0] gm_quote, gm_fill;

            // GM cycle 0: symbol=0 (AAPL), CALM, bid=0x00B3F81E, ask=0x00B4081E
            ...
            // GM cycle 1: symbol=1 (MSFT), bid=0x01A3F821, ask=0x01A40821
            ...
            // GM cycle 2: symbol=2 (NVDA), bid=0x0383F816, ask=0x03840816
            ...
            // GM cycle 20: FILL frame — symbol=0, BUY, FILLED
            // fill_price=0x00B40815, qty=100, order_id=1, ts_echo=42
