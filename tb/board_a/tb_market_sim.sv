...
module tb_market_sim;
    ...
    initial begin
        ...
        pulse_lfsr_load();
        enable = 1'b1;
        repeat (4) begin wait_quote(); @(posedge clk); #1; end
        #1;
        ...
        pulse_lfsr_load();
        enable = 1'b1;
        repeat (2) begin wait_quote(); @(posedge clk); #1; end
        begin
        ...
        pulse_lfsr_load();
        enable = 1'b1;
        repeat (5) begin wait_quote(); @(posedge clk); #1; end
        #1;
