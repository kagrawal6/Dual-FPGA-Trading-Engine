# ============================================================================
# apply_pl0_100mhz_board_a.tcl — Set PS PL0 fabric clock to 100 MHz (Board A)
# ============================================================================
# Baseline create_board_a.tcl uses 50 MHz for PL0. This script updates an
...
set proj_path  [file join $repo_root vivado hft_board_a hft_board_a.xpr]

if {![file exists $proj_path]} {
    puts "ERROR: Project not found: $proj_path"
    puts "       Create it first: source vivado/create_board_a.tcl"
    return
}
...
puts "INFO: PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ set to 100 MHz for Board A."
